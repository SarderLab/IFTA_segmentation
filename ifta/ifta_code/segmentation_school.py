...
def main(args):
    ...
    from ifta_code.Codes.InitializeFolderStructure import initFolder, purge_training_set, prune_training_set
    if args.one_network == 'True' or args.one_network == 'true' or args.one_network == 'TRUE':
        # from ifta_code.Codes.IterativeTraining_1X import IterateTraining
        from ifta_code.Codes.IterativePredict_1X import predict, validate
    else:
        from ifta_code.Codes.evolve_predictions import evolve
        from ifta_code.Codes.IterativeTraining import IterateTraining
        from ifta_code.Codes.IterativePredict import predict, validate
...
if __name__ == '__main__':
    ...
    parser.add_argument('--iteration', dest='iteration', default='1', type=str,
