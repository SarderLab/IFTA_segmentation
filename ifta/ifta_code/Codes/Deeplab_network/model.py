...
from network import *
sys.path.append('..')
from ifta_code.Codes.Deeplab_network.utils.image_reader import ImageReader, read_labeled_image_list
from ifta_code.Codes.Deeplab_network.utils.label_utils import decode_labels, inv_preprocess, prepare_label
from ifta_code.Codes.Deeplab_network.utils.write_to_log import write_log
...
class Model(object):
	...
	def predict(self):
		...
		#checkpointfile = self.conf.modeldir
		self.load(self.loader, checkpointfile)
